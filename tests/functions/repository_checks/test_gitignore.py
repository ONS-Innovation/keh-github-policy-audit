"""Unit tests for gitignore repository check handler."""

import importlib
from unittest.mock import create_autospec, patch

module = importlib.import_module("functions.repository_checks.gitignore.handler")
...
class TestGitignoreHandler:
    def test_wire_client_and_repo(self) -> None:
        ...
        with (
            ...
            patch.object(module, "check_gitignore", mock_check),
        ):
        ...
        assert result == {"status": "PASS", "check_name": "gitignore"}
